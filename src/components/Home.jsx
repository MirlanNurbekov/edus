...
export default function Home() {
  const services = [
    { title: 'Консультация по визам', text: 'Экспертная помощь в сборе документов и заполнении анкет.' },
    { title: 'Поступление в ВУЗ',       text: 'Подбор университетов, помощь в оформлении и сопровождение.' },
    { title: 'Подготовка к тестам',      text: 'Курсы по подготовке к IELTS, TOEFL, SAT и другим экзаменам.' },
  ];
